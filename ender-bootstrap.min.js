...
/*!
    ...
    * MIT License
    */
!function(){function l(e,t){var n=[];u=e.childNodes;for(r=0,i=u.length;r<i;r++)u[r].nodeType==1&&(!t||u[r].nodeName==t)&&n.push(u[r]);return n}function c(e,t,n,s){if(!n)return t[s-1]==e;for(r=s,i=t.length;n>0?r<=i:r>=1;r+=n)if(e==t[r-1])return!0;return!1}function h(e,t,n){return isFinite(n)?t[n-1]==e:n=="odd"?c(e,t,2,1):n=="even"?c(e,t,2,0):(a=f.exec(n))?c(e,t,a[2]?parseInt(a[1],10):parseInt(a[1]+"1",10),a[3]?parseInt(a[3].replace(/\s*/,""),10):0):!1}function p(e,t){if(e.nodeType===3||e.nodeType===4)return e.nodeValue;if(e.nodeType!==1&&e.nodeType!==9)return"";for(t="",e=e.firstChild;e;e=e.nextSibling)e.nodeType!==8&&(t+=e.textContent||e.innerText||p(e));return t}var t,n,r,i,s,o,u,a,f=/\s*((?:\+|\-)?(\d*))n\s*((?:\+|\-)\s*\d+)?\s*/;if(typeof e!="undefined"&&!0)t=require("qwery");else{if(typeof qwery=="undefined")return;t=qwery}n=t.pseudos,n.contains=function(e,t){return p(e).indexOf(t)!=-1},n.not=function(e,n){return!t.is(e,n)},n["nth-child"]=function(e,t){return!t||!(s=e.parentNode)?!1:h(e,l(s),t)},n["nth-last-child"]=function(e,t){return!t||!(s=e.parentNode)?!1:h(e,l(s).reverse(),t)},n["nth-of-type"]=function(e,t){return!t||!(s=e.parentNode)?!1:h(e,l(s,e.nodeName),t)},n["nth-last-of-type"]=function(e,t){return!t||!(s=e.parentNode)?!1:h(e,l(s,e.nodeName).reverse(),t)},n["first-child"]=function(e){return n["nth-child"](e,1)},n["last-child"]=function(e){return n["nth-last-child"](e,1)},n["first-of-type"]=function(e){return n["nth-of-type"](e,1)},n["last-of-type"]=function(e){return n["nth-last-of-type"](e,1)},n["only-child"]=function(e){return(s=e.parentNode)&&(u=l(s))&&u.length==1&&e==u[0]},n["only-of-type"]=function(e){return(s=e.parentNode)&&(u=l(s,e.nodeName))&&u.length==1&&e==u[0]},n.target=function(e){return e.getAttribute("id")==location.hash.substr(1)},n.checked=function(e){return e.checked},n.enabled=function(e){return!e.disabled},n.disabled=function(e){return e.disabled},n.empty=function(e){return!e.childNodes.length}}(),provide("qwery-pseudos",e.exports),$.ender(e.exports)}()